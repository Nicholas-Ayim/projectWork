...
export default function Notification({ newRequest }) {
  return (
    <>
      <div>
      ...
      <div className="sub-heading-container">
        ...
        <div className="find-request">
            <input type="text" placeholder="find a request" className="find-student-input"/>
            <BsSearch className="request-search-icon"/>
        </div>
      </div>
      <div>
        <RequestMessages newRequest={newRequest} />
      </div>
    </>
  );
}
